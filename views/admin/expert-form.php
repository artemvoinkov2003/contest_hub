...
$this->title = $model->isNewRecord ? 'Добавить эксперта' : 'Редактировать эксперта: ' . $model->getFullName();
$this->params['breadcrumbs'][] = ['label' => 'Эксперты', 'url' => ['experts']];
$this->params['breadcrumbs'][] = $model->isNewRecord ? 'Добавить эксперта' : 'Редактировать';
?>
    ...
    <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl border border-blue-100 p-6">
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                <a href="<?= \yii\helpers\Url::to(['experts']) ?>" class="px-6 py-3 border border-gray-300 text-base font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200">
                    Отмена
                </a>
                <?= Html::submitButton($model->isNewRecord ? 'Создать эксперта' : 'Обновить данные', [
